...
public class HomeWenBaActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_wenba);
        initDates();
        initViews();
    }
    ...
    private void initDates(){
        try{
            url = URLData.getUrlWenBa(UserInfo.getInstance().getUser().getTeacherId());
        }catch (Exception e){
